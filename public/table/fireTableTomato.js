...
var thComp = document.getElementById('compThTomato');
...
var tdComp = document.getElementById('compTdTomato');
...
var thGrow = document.getElementById('growThTomato');
...
var tdGrow = document.getElementById('growTdTomato');
...
function AddItemToTableGrowTd(gStage,startStage,endStage,inOut,desc,humidity,temperature,co2,lTime,PPFD,DLI,ph,nutrient){
    ...
    async function GetDocumentGrow() {
        const dbRef = collection(db,"GrowTomato");
        ...
        var totalHum = 0;
         ...
         var refFlower = doc(db,"GrowTomato", "1Leaf");
         const docRef = await setDoc(
           refFlower, {
            GrowingStage: "Leaf",
            StartStage: "hnfgh",
